...
public abstract class DataModule {
    ...
    @javax.inject.Singleton()
    @org.jetbrains.annotations.NotNull()
    public abstract com.sleepmate.domain.repository.AlarmRepository bindAlarmRepository(@org.jetbrains.annotations.NotNull()
    com.sleepmate.data.repository.AlarmRepositoryImpl alarmRepositoryImpl);
    
    @dagger.Binds()
    @javax.inject.Singleton()
    @org.jetbrains.annotations.NotNull()
    public abstract com.sleepmate.domain.repository.OnboardingRepository bindOnboardingRepository(@org.jetbrains.annotations.NotNull()
    com.sleepmate.data.repository.OnboardingRepositoryImpl onboardingRepositoryImpl);
    
    @dagger.Binds()
    @javax.inject.Singleton()
    @org.jetbrains.annotations.NotNull()
    public abstract com.sleepmate.domain.repository.HealthDataRepository bindHealthDataRepository(@org.jetbrains.annotations.NotNull()
    com.sleepmate.data.health.HealthDataRepositoryImpl healthDataRepositoryImpl);
    
    @dagger.Binds()
    @javax.inject.Singleton()
    @org.jetbrains.annotations.NotNull()
    public abstract com.sleepmate.domain.repository.SleepHistoryRepository bindSleepHistoryRepository(@org.jetbrains.annotations.NotNull()
    com.sleepmate.data.repository.SleepHistoryRepositoryImpl sleepHistoryRepositoryImpl);
    
    @dagger.Binds()
    @javax.inject.Singleton()
    @org.jetbrains.annotations.NotNull()
    public abstract com.sleepmate.domain.repository.DailyHealthMetricsRepository bindDailyHealthMetricsRepository(@org.jetbrains.annotations.NotNull()
    com.sleepmate.data.repository.DailyHealthMetricsRepositoryImpl dailyHealthMetricsRepositoryImpl);
}