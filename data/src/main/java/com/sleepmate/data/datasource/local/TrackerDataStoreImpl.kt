...
class TrackerDataStoreImpl @Inject constructor(
    ...
    override suspend fun getDefaultHabits(): List<SleepHabit> {
        return listOf(
            SleepHabit(
                title = "No screen 1 hour before bed",
                subtitle = "Avoid phones, tablets, and TV",
                isCompleted = false,
                isSuggested = true
            ),
            SleepHabit(
                title = "Read a book",
                subtitle = "10-15 minutes of relaxing reading",
                isCompleted = false,
                isSuggested = true
            ),
            SleepHabit(
                title = "Meditation or deep breathing",
                subtitle = "5-10 minutes of mindfulness",
                isCompleted = false,
                isSuggested = true
            ),
            SleepHabit(
                title = "Prepare tomorrow's clothes",
                subtitle = "Reduce morning stress",
                isCompleted = false,
                isSuggested = true
            ),
            SleepHabit(
                title = "Drink herbal tea",
                subtitle = "Chamomile or lavender tea",
                isCompleted = false,
                isSuggested = true
            )
        )
